...
const Input = ({ inputType, title, placeholder, handleClick }) => {
  ...
  <div className="mt-10 w-full">
    <p className="font-semibold font-poppins text-xl font-poppins dark:text-white text-nft-black-1">
      {title}
    </p>
    ...
    { inputType === 'number' ? (
      <div className="dark:bg-nft-black-1 bg-white border dark: border-nft-black-1 border-nft-gray-2 rounded-lg w-full outline-none font-poppins dark:text-white text-nft-gray-2 text-base mt-4 px-4 py-3 flexBetween flex-row">
        ...
        />
        <p className="font-semibold font-poppins text-xl font-poppins dark:text-white text-nft-black-1">{nftCurrency}</p>
      </div>
    ) : inputType === 'textarea' ? (
      <textarea
        rows={10}
